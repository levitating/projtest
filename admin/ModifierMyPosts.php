...
else 
{
	...
	else 
	{
		...
		if ( $mesValeurs["status_actualite"] == 1 )
		{
			$_SESSION["MESSAGES_CAT_ERREUR"] = "Actualité deja valitdée";
			header("location: AfficherPosts.php#actualite");
		}		
		if (isset($_POST["titreActualite"]) or isset($_POST["contenuActualite"])  or isset($_POST["langueActualite"]) or isset($_POST["categorieActualite"])) 
		{
			...
			$objectActualite->modifierMyActualite ($myIdAModifier,$_POST["titreActualite"],$_POST["contenuActualite"], $_POST["langueActualite"], $_POST["categorieActualite"] , "2");
		}
