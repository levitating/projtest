...
else 
{
	...
	else 
	{
		...
		if (isset($_POST["submitPublier"])) 
		{
			
			$objectActualite->updateStatusActualite ($myIdAModifier,$_POST["titreActualite"],$_POST["contenuActualite"],$_POST["langueActualite"],$_POST["categorieActualite"]  , "1");
		}
		elseif (isset($_POST["submitRefuser"])) 
		{
...
?>	
        <div class="text-left" href="#actualite">
			<h3>Actualités<small> Valider une actualité</small></h3>
			<br>
			<form action="ModifierPostsValidation.php?monpost=<?php echo $myIdAModifier; ?>#actualite" method="POST" >
				...
				<center>
					<button type="submit" name="submitPublier" class="btn btn-success" style="width: 49%;" >Publier</button>
					<button type="submit" name="submitRefuser" class="btn btn-danger" style="width: 49%;" >Réfuser</button>
				</center>
